...
function serialize(options) {
  ...
  const files = {
    hnFile: pipeline.obj(csvWriter(), createWriteStream(join(outPath, 'cadastre-housenumbers.csv'))),
    gFile: pipeline.obj(csvWriter(), createWriteStream(join(outPath, 'cadastre-groups.csv')))
  }
