...
function getPositionType(positionType) {
  if (positionType === 'entrée') return 'entrance'
  if (positionType === 'parcelle') return 'parcel'
  return ''
}
...
function convertAdresse(adresse) {
  ...
  return {
    lon: adresse.bestPosition ? adresse.bestPosition.geometry.coordinates[0] : '',
    lat: adresse.bestPosition ? adresse.bestPosition.geometry.coordinates[1] : '',
    positionType: adresse.bestPosition ? getPositionType(adresse.bestPosition.type) : '',
